...
function deleteFromLocalStorage(orderId) {
    var orderList = getOrderListFromLocalStorage();
    var newOrderList = orderList.filter(function(order) {
...
function getOrderListFromLocalStorage() {
    var orderList = localStorage.getItem('orders');
    if (orderList) {
